...
params = {
    'alpha': {'_type': 'choice', '_value': [0.1, 0.5, 1.0]},
    'alpha': {'_type': 'choice', '_value': [0.5, 1.0, 2.0, 5.0]},
}
port = 21423
exp_id = None
...
experiment = Experiment('local', exp_id)
...
experiment.config.trial_command = "CUDA_VISIBLE_DEVICES=0 python train_auto.py \
...
experiment.config.training_service.max_trial_number_per_gpu = 3
experiment.config.training_service.use_active_gpu = True
# experiment.config.training_service.gpu_indices = [0, 1, 3]
