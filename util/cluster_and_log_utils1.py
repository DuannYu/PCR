from util.cluster_utils import cluster_acc, np, linear_assignment
...
def log_accs_from_preds1(y_true, y_pred, mask, eval_funcs: List[str], save_name: str, T: int=None, writer: SummaryWriter=None,
                        print_output=False):
